  ...
  useEffect(() => {
    ...
    const matrix = () => {
      ...
      ctx.fillStyle = theme === 'dark' 
        ...
        ? 'rgba(3, 7, 17, 0.07)' // Darker background in dark mode
      ...
      // Use theme-appropriate text color with increased opacity

      ctx.fillStyle = theme === 'dark'

        ? 'rgba(59, 130, 246, 0.9)' // Brighter blue in dark mode

        : 'rgba(22, 163, 74, 0.9)' // Brighter green in light mode
